...
<h1>Авторы</h1>
    <table>
        ...
        /*
             ...
             */
        // $sqlin = "";
        $userbd = mysqli_query($db, "SELECT * FROM authors");
        ...
        ?>
            <tr>
                ...
                <td><?= $userbd[2] ?></td>
                <td><?= $userbd[3] ?></td>
                <td><a href="BDauthorsUPdate.php?id=<?= $userbd[0] ?>">Изменить</a></td>
                <td><a style="color: red;" href="deleteAuthors.php?id=<?= $userbd[0] ?>">Удалить</a></td>
            </tr>
        <?php
        }
        ?>
...
<h3>Добавить нового автора</h3>
    <form action="createAuthors.php" method="post">
        <p>Фамилия</p>
